...
import vitalize.Models.activite;
import vitalize.Models.evenement;
import vitalize.Services.Activityservice;
import vitalize.Services.EventService;
...
public class DisplayEvent implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ListEvents.getItems().addAll(es.fetch());
    ...
    public void back(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/DisplayActivity.fxml"));
            Parent root = loader.load();
